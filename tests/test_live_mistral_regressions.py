"""Regression tests distilled from malformed live Mistral responses.
...
import mistral_formatter as formatter
...
class LiveDialogueRegressionTests(unittest.TestCase):
    ...
    def test_actual_jim_dialogue_keeps_canonical_speaker_id(self) -> None:
        ...
        description = format_mistral_prompt(malformed, context)[DESCRIPTION]
    ...
    def test_redundant_period_after_dialogue_close_is_removed(self) -> None:
        ...
        description = format_mistral_prompt(malformed, context_for(3))[DESCRIPTION]
    ...
    def test_descriptive_speaking_role_does_not_become_a_subject(self) -> None:
        ...
        formatted = format_mistral_prompt(malformed, context)
        description = formatted[DESCRIPTION]
        issues = validate_mistral_prompt(formatted, context)
    ...
    def test_registered_mark_says_remains_valid_without_new_subject(self) -> None:
        ...
        self.assertFalse(any(
            ...
            for issue in validate_mistral_prompt(formatted, context)
        ))
    ...
    def test_stray_closed_lips_clause_without_voiceover_is_rejected(self) -> None:
        ...
        formatted = format_mistral_prompt(malformed, context_for(3))
        issues = validate_mistral_prompt(formatted, context_for(3))
...
class LiveVisualFormattingRegressionTests(unittest.TestCase):
    ...
    def test_decimal_seconds_opening_timestamp_is_normalized(self) -> None:
        ...
        description = format_mistral_prompt(malformed, context_for(2))[DESCRIPTION]
...
class LiveSoundscapeRegressionTests(unittest.TestCase):
    ...
    def test_mixed_spoken_line_and_instrument_sentence_is_removed_whole(self) -> None:
        ...
        soundscape = format_mistral_prompt(malformed, context_for(4))[SOUNDSCAPE]
...
class LiveBeatFourSemanticRegressionTests(unittest.TestCase):
    ...
    def test_unseen_family_does_not_satisfy_visible_b4_abduction(self) -> None:
        ...
        formatted = format_mistral_prompt(malformed, self._b4_context())
        issues = validate_mistral_prompt(formatted, self._b4_context())
