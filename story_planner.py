    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "RIGHT:\n"
                f"{right_unit.text}\n\n"
                "Choose MERGE or NEW_TASK. Apply these rules in order:\n"
                "1. STOPPING POINT: if LEFT explicitly completes a protection, "
                "victory, repair, shutdown, assembly, delivery, or other objective, "
                "RIGHT is NEW_TASK when it starts a later distinct action. Testing, "
                "calibrating, inspecting, transporting, fetching new equipment, "
                "releasing people, or starting another operation after that completion "
                "is NEW_TASK.\n"
                "2. SAME-OBJECT EXCEPTION: MERGE only when RIGHT immediately continues "
                "handling the exact object/container LEFT just obtained, opened, "
                "unlocked, or started. The LEFT object itself must be what RIGHT acts "
                "on. This exception does not apply to an object LEFT finished building, "
                "assembling, or repairing.\n"
                "3. NEW-PROBLEM RESPONSE: MERGE when LEFT itself introduces a new "
                "problem, danger, alarm, or request and RIGHT immediately addresses "
                "that trigger. A completed protection/solution does not count as a "
                "new problem.\n"
                "4. SAME ACTION: MERGE when RIGHT continues the same uninterrupted "
                "local action as LEFT.\n"
                "Otherwise choose NEW_TASK. Shared earlier danger, purpose, "
                "opportunity, access, or readiness is not enough to MERGE.\n"
