    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "TARGET UNIT:\n"
                f"{unit.text}\n\n"
                "A HARD RESET means a discontinuity between actual narrative "
                "phases: an explicit time jump, scene break, relocation after a "
                "completed phase, or equivalent restart. A genre/premise/summary "
                "sentence is NOT an actual completed phase, so moving from framing "
                "into the story's first concrete scene is NO. Immediate "
                "cause-and-effect action in the same continuous sequence is NOT a "
                "hard reset, even if danger, equipment, or physical location "
                "changes.\n\n"
