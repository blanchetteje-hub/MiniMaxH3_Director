    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "RIGHT:\n"
                f"{right_unit.text}\n\n"
                "Choose MERGE or NEW_TASK.\n"
                "MERGE only if one rule applies:\n"
                "1. RIGHT continues the same uninterrupted action as LEFT.\n"
                "2. LEFT itself explicitly introduces a problem, danger, alarm, or "
                "request, and RIGHT is the immediate response that addresses that "
                "trigger. Mere opportunity, access, or readiness is not a trigger.\n"
                "3. RIGHT immediately completes handling of the exact object, "
                "container, or action LEFT just obtained, opened, unlocked, or "
                "started. The LEFT object itself must be what RIGHT acts on; a tool "
                "used on another target does not qualify.\n"
                "Rule 2 never applies when LEFT is already a completed solution, "
                "protection, victory, shutdown, repair, or finished task. If LEFT "
                "explicitly finishes/completes an object-level task, a later test, "
                "inspection, transport, repair, or other operation is NEW_TASK.\n"
                "Otherwise choose NEW_TASK. Judge only the concrete local actions.\n"
